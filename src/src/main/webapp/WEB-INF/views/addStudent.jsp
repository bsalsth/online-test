						...
						<div class="box dark">
							...
							<div id="div-1" class="accordion-body collapse in body">
								<form class="form-horizontal">
									...
									<div class="form-group">
										<label for="text1" class="control-label col-lg-4">Student Id</label>
									...
									<div class="form-group">
										<label for="text1" class="control-label col-lg-4">Student
											Id</label>
										<div class="col-lg-8">
											<input type="text" id="text1" placeholder="Email"
												class="form-control" />
									...
									<div class="form-group">
										<label  class="control-label col-lg-4">Select Coach</label>
										<div class="col-lg-8">
